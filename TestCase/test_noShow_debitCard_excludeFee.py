...
class Test_noShow_debitCard_excludeFee():
    ...
    def test_noShow_debitCard_excludeFee(self, get_global_data):
        noShowAmount=50
        ...
        accountBalance=oriAccountBalance+noShowAmount-applicationFee
